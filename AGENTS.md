...
- Keep the skill synchronized for agent runtimes in `.claude/skills/mlzidla-scrollcraft-astra/`, `.agents/skills/mlzidla-scrollcraft-astra/` and `agent/skills/mlzidla-scrollcraft-astra/` when its rules change.
