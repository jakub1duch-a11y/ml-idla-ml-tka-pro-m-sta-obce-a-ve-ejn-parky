...
function buildHtml({ message, portalUrl, presentationUrl, quotePdfUrl, validUntil, quoteNumber, projectSummary = '', emailType = 'offer', discountPercent = 0, previousTotal = 0, newTotal = 0, visualizationItems = [] }) {
