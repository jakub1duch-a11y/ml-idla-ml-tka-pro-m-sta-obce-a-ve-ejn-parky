...
const STATIC_PAGES = [
  ...
  { loc: '/mlzitko', priority: '0.9', changefreq: 'weekly' },
  ...
  { loc: '/jak-to-funguje', priority: '0.8', changefreq: 'monthly' },
  { loc: '/vodni-mlha', priority: '0.85', changefreq: 'monthly' },
  { loc: '/mlhoviste', priority: '0.85', changefreq: 'monthly' },
  { loc: '/mlzne-brany', priority: '0.8', changefreq: 'monthly' },
  { loc: '/smart-ovladani', priority: '0.8', changefreq: 'monthly' },
