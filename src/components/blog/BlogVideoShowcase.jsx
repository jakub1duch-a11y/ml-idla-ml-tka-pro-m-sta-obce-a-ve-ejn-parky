...
const VIDEOS = [
  ...
  { title: 'Mlžná brána — sekvence II', text: 'Další uložený záběr průchodu a práce mlhy v bráně.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/66dd73724_1283CEC3-EA3F-42B3-9E58-3788630B07A6.MOV', group: 'detail' },
  { title: 'Mlžení zblízka — sekvence II', text: 'Alternativní detail mikrokapek a jemnosti vodní mlhy.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/1d1271290_4419E385-9A17-4EF1-AA75-90C2B12ACDE3.MOV', group: 'detail' },
  { title: 'Mlžítka v ZOO Praha', text: 'Živá ukázka instalace v návštěvnickém provozu.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/27d926a20_MlzitkavarealuZOOPraha-zivaukazka.mov', poster: '/media/optimized/4737b1d8d_5b1b2bcc1b140ee76c8402a1e6313b8f.webp', group: 'realizace' },
  { title: 'Mlžná brána — živý efekt', text: 'Jemná mlha a její pohyb přímo v prostoru.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/c857caa78_Efektmlhy-mlznabrana-zivynahled.mov', poster: '/media/optimized/5401e0933_dac8b98065c5472b16bc1910348915a1.webp', group: 'produkt' },
  { title: 'Mlžný strom OSTREV', text: 'Živá ukázka mlžného stromu a charakteru mlhy.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/30dac59df_Mlzitkaostev-zivaukazkamlznystrom.mov', group: 'produkt' },
  { title: 'GATE70 v parku', text: 'Mlžná brána v reálném městském prostředí.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/aa11e932c_mlnbrnaGATE70.mp4', group: 'produkt' },
  { title: 'Detail mlhy GATE', text: 'Detail trysek a mlžného efektu brány.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/a4733f633_detailnamlhumlznebrany.MOV', group: 'produkt' },
  { title: 'Mlžná brána v akci', text: 'Průchod mlžnou bránou a intenzita mlžení.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/37a6da879_mlzeni-mlznbrany-vakci.MOV', group: 'produkt' },
  { title: 'GATE74 — realizace', text: 'Ukázka větší mlžné brány v provozu.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/352fd3ef1_mlnbrnaGATE74-vakci.MOV', group: 'produkt' },
  { title: 'GATE74 — druhý pohled', text: 'Prostorový pohled na mlžný efekt GATE74.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/4b66409ed_mlnbrnaGATE74-vakci1.MOV', group: 'produkt' },
  { title: 'Mlžná spirála v akci', text: 'Autorský nerezový prvek při aktivním mlžení.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/ae9faa0a3_video-mlitkospiralavakci.MOV', group: 'produkt' },
  { title: 'Mlžítka pro parky a města', text: 'Sekvence městské instalace a práce mlhy v prostoru.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/eb7e87313_mlzidla-mlzitkaproparkyamesta03.MOV', group: 'realizace' },
  { title: 'Detail instalace v parku', text: 'Krátká sekvence produktu a okolního veřejného prostoru.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/9f0153e3a_ml_detailvparku_01.MOV', group: 'realizace' },
  { title: 'Městská instalace — sekvence', text: 'Další pohled na mlžítka pro parky a města.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/2ffb4d391_mlzidla-mlzitkaproparkyamesta04.MOV', group: 'realizace' },
  ...
  { title: 'Mlžení zblízka', text: 'Detail mikrokapek a charakteru jemné vodní mlhy.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/bc59d4ed7_4419E385-9A17-4EF1-AA75-90C2B12ACDE3.MOV', group: 'detail' },
  { title: 'Jemná mlha v provozu', text: 'Detailní sekvence aktivního mlžení.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/2dbc1232d_EFC9FCE8-7138-44C3-AAE6-246F88644813.MOV', group: 'detail' },
  { title: 'Mlžná brána — sekvence', text: 'Krátká živá ukázka mlžné brány.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/858a3a3f3_1283CEC3-EA3F-42B3-9E58-3788630B07A6.MOV', group: 'detail' },
  { title: 'Chladivý efekt naživo', text: 'Pohyb mlhy a její rozptyl v bezprostředním okolí.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/ce13ff8ac_AF599DD3-EFF1-43AB-B6AB-40C8B869039F.MOV', group: 'detail' },
  ...
  { title: 'Svařování — živá ukázka', text: 'Další pohled přímo do procesu výroby MLŽIDLA®.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/2d9d98473_Svaovnukzkazive.mov', poster: '/media/optimized/66c02aadb_Screenshot_20260712_212842.webp', group: 'vyroba' },
  { title: 'Parky a hřiště', text: 'Vizualizační videosekvence řešení pro veřejný prostor.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/3c3e64d18_generated_video.mp4', group: 'sekvence' },
  { title: 'Koupaliště a aquaparky', text: 'Videosekvence využití mlžení ve vodních areálech.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/9eb62596b_generated_video.mp4', group: 'sekvence' },
  { title: 'Školy a dětské prostory', text: 'Vizualizační sekvence mlžení pro dětské a školní areály.', url: 'https://media.base44.com/videos/public/6a3ee88c10959cd3588c4d68/e557b652c_generated_video.mp4', group: 'sekvence' },
