...
export default function ProductFilterGrid({ mode = 'sculptures' }) {
  ...
  return <section className="site-container lg:py-1 0 py-6">
    <div className="mb-9 max-w-3xl"><p className="content-eyebrow mb-3 hidden">{content.eyebrow}</p><h2 className="text-3xl text-[hsl(var(--ring))] [font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] font-medium">{content.title}</h2><p className="content-lead mt-3 text-justify">{content.text}</p></div>
