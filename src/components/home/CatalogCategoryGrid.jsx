...
export default function CatalogCategoryGrid({ categories }) {
  return <section id="kolekce" className="py-20 sm:py-28">
    <div className="site-container">
      ...
      <div className="mb-10 flex flex-wrap items-end justify-between gap-4"><h2 className="m-0 [font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] font-medium text-4xl">Kolekce mlžných systémů</h2><Link to="/katalog" className="text-sm font-bold text-primary hover:underline">Celý katalog</Link></div>
