...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-ink">
      ...
      {/* Main content */}
      <div className="relative flex flex-col justify-end w-full pt-36 pb-12 px-6 z-5 max-w-7xl lg:px-8 mx-auto flex-">
        ...
        <div className="items-end flex gap-6">
          ...
          <div className="flex divide-x lg:w-auto ml-auto overflow-hidden backdrop-blur-xl rounded-2xl divide-slate-10/10 bg-white/5">
            {stats.map((s) =>
            <div key={s.val} className="opacity-100 pb-4 text-left pl-10 pr-7 pt-7">
