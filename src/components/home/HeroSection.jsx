    ...
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-ink">
      ...
      <AnimatePresence initial={false}>
        <motion.div
          ...
          <div className="absolute bg-gradient-to-r from-ink/80 via-ink/30 to-transparent inset-" />
        </motion.div>
      </AnimatePresence>
      ...
      <div className="relative flex-1 flex flex-col justify-end w-full pt-36 pb-12 px-6 z-5 max-w-7xl lg:px-8 mx-auto">
        ...
        <div className="mt-10 flex items-end gap-6">
          ...
          <div className="grid grid-cols-4 gap-2 lg:w-auto ml-auto">
            {stats.map((s) =>
            <div key={s.val} className="bg-white/8 backdrop-blur-sm border text-center border-white/30 rounded-1xl px-32 py-1">
