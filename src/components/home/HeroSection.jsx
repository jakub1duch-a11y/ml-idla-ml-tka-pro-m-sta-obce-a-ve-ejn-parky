...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-ink">
      ...
      {/* Slide counter bar */}
      <div className="absolute top-0 left-0 right-0 z-20 flex gap-1 px-6 lg:px-8 pt-16 text-[hsl(var(--primary))]">
        {slides.map((_, i) =>
        <button
          key={i}
          onClick={() => goTo(i)}
      ...
      {/* Main content */}
      <div className="relative z-10 flex-1 flex flex-col justify-end max-w-7xl mx-auto px-6 lg:px-8 pb-12 w-full pt-36">
