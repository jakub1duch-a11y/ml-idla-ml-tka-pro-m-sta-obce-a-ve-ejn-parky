  ...
  return <section className="border-y border-slate-200 bg-slate-50 py-10">
    <div className="site-container">
      <Link to="/katalog?sekce=pronajem" className="group grid gap-6 rounded-2xl border border-slate-200 bg-white p-6 transition hover:border-slate-300 hover:shadow-lg md:grid-cols-[auto_1fr_auto] md:items-center">
        <span className="flex h-12 w-12 items-center justify-center rounded-full bg-slate-950 text-cyan"><CalendarDays size={21} /></span>
        ...
        <span className="inline-flex items-center gap-2 text-sm font-bold text-slate-900">Více o pronájmu <ArrowRight size={16} className="transition group-hover:translate-x-1" /></span>
      </Link>
    </div>
  </section>;
}