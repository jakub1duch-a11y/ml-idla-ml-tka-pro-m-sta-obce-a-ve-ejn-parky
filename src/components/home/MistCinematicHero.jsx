...
export default function MistCinematicHero() {
  return (
    <section id="uvod" aria-label="Mlžidla.cz — nízkotlaké mlžné systémy" className="relative mx-auto mt-24 aspect-[255/188] w-full max-w-[1020px] overflow-hidden rounded-[12px] bg-[#062238] text-white">
      <img src="https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/852e0b551_d0243ef5-e0cd-4555-b552-8fe9e2f7b2d9.png" alt="Technický nákres mlžné brány" fetchPriority="high" decoding="async" className="pointer-events-none absolute -left-[8.83%] -top-[7.45%] h-auto w-[117.65%] max-w-none select-none" />
