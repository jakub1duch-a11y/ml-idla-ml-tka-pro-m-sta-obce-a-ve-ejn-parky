...
export default function MistCinematicHero() {
  return (
    <section id="uvod" aria-label="Mlžidla.cz — nízkotlaké mlžné systémy" className="relative w-full bg-[#062238] text-white rounded-[12px] max-w-[1020px] mx-auto overflow-hidden mt-24 aspect-[2/188]">
