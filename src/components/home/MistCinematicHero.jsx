...
export default function MistCinematicHero() {
  return (
    <section id="uvod" aria-label="Mlžidla.cz — nízkotlaké mlžné systémy" className="relative mx-auto mt-24 w-full max-w-[1020px] overflow-hidden rounded-[12px] bg-[#062238] text-white aspect-[2188]">
