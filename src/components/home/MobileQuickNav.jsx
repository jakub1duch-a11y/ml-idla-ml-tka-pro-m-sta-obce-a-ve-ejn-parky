...
{ icon: Wifi, label: 'Smart řízení', to: '/smart-ovladani' },
    ...
    <div className="sm:hidden bg-white border-b border-slate-100 py-3">
      <div className="flex gap-2 overflow-x-auto px-4 [&::-webkit-scrollbar]:hidden" style={{ scrollbarWidth: 'none' }}>
        ...
        <Link
          key={l.to}
          to={l.to}
          className="flex-shrink-0 flex items-center gap-1.5 px-4 py-2 rounded-full bg-slate-50 border border-slate-200 text-slate-700 text-xs font-medium whitespace-nowrap active:bg-slate-100 transition-colors">
