        ...
        <div className="grid gap-12 lg:grid-cols-[.95fr_1.05fr] lg:gap-16">
          <div>
            ...
            <motion.p initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 0.6, delay: 0.12 }} className="mt-6 max-w-2xl text-base leading-8 text-slate-600">
              Klientská sekce propojuje poptávku, vizualizace, cenovou nabídku, dokumenty a další kroky projektu do jednoho bezpečného pracovního prostoru. Technická data vycházejí pouze z ověřených podkladů; neznámé parametry se nedopočítávají odhadem.
            </motion.p>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Link to="/klientska-sekce" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-slate-300 bg-white/80 px-6 py-3 text-sm font-semibold text-[#0d2d38] backdrop-blur hover:border-cyan-300">
                Přihlásit do klientské sekce
              </Link>
            </div>
              ...
              <div className="rounded-[28px] bg-[#0d2d38] p-5 text-white sm:p-6">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <h3 className="mt-2 text-2xl font-light">Klientská sekce MLŽIDLA®</h3>
                  </div>
