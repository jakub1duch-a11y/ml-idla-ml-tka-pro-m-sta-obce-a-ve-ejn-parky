...
export default function ScrollMistExperience() {
  return <section id="pribeh" className="bg-slate-950">
    <div className="mx-auto max-w-7xl px-6 py-20 text-center lg:px-10 lg:py-28">
      <p className="text-xs font-bold uppercase tracking-[0.22em] text-cyan">Příběh ochlazení</p>
      ...
      <p className="mx-auto mt-5 max-w-2xl text-white/65">Projďte si příběh nízkotlakého mlžení v rozsahu 2–8 bar (200–800 kPa) a jeho vliv na pohodu, pohyb i atmosféru místa.</p>
    </div>
