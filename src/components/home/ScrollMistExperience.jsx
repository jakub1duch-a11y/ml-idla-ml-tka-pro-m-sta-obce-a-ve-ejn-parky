...
export default function ScrollMistExperience() {
  return <section id="inspirace" className="bg-slate-950">
    <div className="mx-auto max-w-7xl px-6 py-20 text-center lg:px-10 lg:py-28">
      <p className="text-xs font-bold uppercase tracking-[0.22em] text-cyan">Scroll motion inspirace</p>
      <h2 className="mx-auto mt-4 max-w-3xl font-heading text-4xl font-medium tracking-tight text-white lg:text-6xl">Od žáru po úlevu — krok za krokem.</h2>
      <p className="mx-auto mt-5 max-w-2xl text-white/65">Projďte si příběh nízkotlakého mlžení a jeho vliv na pohodu, pohyb i atmosféru místa.</p>
    </div>
