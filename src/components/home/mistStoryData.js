...
export const MIST_STORY_SCENES = [
  { number: '01', eyebrow: 'Tepelný ostrov', title: 'Horko mění město v prostor, kde se nechce zůstávat.', text: 'Rozpálená dlažba, ostré světlo a vzduch bez úlevy. První krok ke změně je vytvořit místo, kam lidé mohou vstoupit.', video: urbanVideo, mode: 'heat', tags: ['Letní špička', 'Veřejný prostor'] },
  { number: '02', eyebrow: 'Aktivace', title: 'TeePe Mist spouští jemný chladivý oblak.', text: 'Nízkotlaké mlžení vytváří viditelnou mlhu, která přirozeně ochlazuje okolní vzduch bez mokré dlažby.', video: installationVideo, mode: 'mist', tags: ['Nízký tlak', 'Mlha aktivní'] },
