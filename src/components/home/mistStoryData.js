...
export const MIST_STORY_SCENES = [
  ...
  { number: '07', eyebrow: 'Návrh s jistotou', title: 'Doporučeno odborníky na mikroklima.', text: 'Navrhujeme systém podle místa, pohybu lidí, zdroje vody a požadovaného efektu.', video: urbanVideo, mode: 'expert', tags: ['Technický návrh', 'Instalace a servis'], actions: [{ label: 'Získat cenovou nabídku', to: '/poptavka', primary: true }, { label: 'Prohlédnout produkty', to: '/katalog' }] },
  { number: '08', eyebrow: 'Živé prostředí', title: 'Parky, náměstí, terasy i festivaly.', text: 'Mlha promění horký okamžik v důvod zůstat déle.', image: 'https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/1fc0ddfc5_generated_image.png', mode: 'real', tags: ['Města', 'Gastro', 'Eventy'], actions: [{ label: 'Řešení pro parky a hřiště', to: '/vyuziti/parky-hriste', primary: true }] },
];
