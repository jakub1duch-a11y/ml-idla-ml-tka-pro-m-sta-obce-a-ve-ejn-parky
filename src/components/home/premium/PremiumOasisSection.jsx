      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="mb-16 grid items-center gap-8 sm:mb-20 sm:gap-10 lg:mb-24 lg:grid-cols-2 lg:gap-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-measure font-body text-base leading-7 text-muted-foreground sm:text-lg sm:leading-relaxed">Jemná mlha snižuje pocitovou teplotu až o 10 °C. Bez klimatizace, bez elektrické spotřeby a bez mokrého povrchu.</p>
          </motion.div>
