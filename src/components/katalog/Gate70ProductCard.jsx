...
export default function Gate70ProductCard() {
  return (
    <Link to="/gate70" className="group relative block min-h-full overflow-hidden rounded-2xl border border-slate-900 bg-slate-950 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hidden">
      <img src="https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/17e1fc843_MlznabranaGATE70U.png" alt="Mlžná brána GATE70" className="absolute inset-0 h-full w-full object-cover opacity-70 transition-transform duration-700 group-hover:scale-105 hidden" loading="lazy" decoding="async" />
      <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/60 to-slate-950/10 hidden" />
