...
{ slug: 'garden', title: 'Zahradní kolekce', eyebrow: 'Zahrady a terasy', text: 'Čisté nerezové mlžítko pro soukromé zahrady, hotelové a restaurační terasy.', image: "https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/eb03ffe38_file_00000000db9072469c9f2e9b61c49933.png" },
...
export default function CollectionOffers() {
  return <section className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-24">
    <div className="max-w-2xl mb-10"><p className="tracking-[.18em] uppercase text-teal-700 mb-3 [font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] font-normal text-lg">KOLEKCE MLŽIDLA®</p><h2 className="font-heading text-slate-950 text-3xl lg:text-3xl">Vyberte řešení podle charakteru místa.</h2></div>
    ...
    <div className="grid gap-5 lg:grid-cols-3">{OFFERS.map((offer) => <Link key={offer.title} to={offer.slug === 'mestske-mlzitka' ? '/mestske-mlzitka' : `/kolekce/${offer.slug}`} className="group border border-[#b9c3c8] bg-card overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-secondary hover:shadow-xl">
