...
const OFFERS = [
  { slug: 'city', title: 'Městská kolekce', eyebrow: 'Města a veřejný prostor', text: 'Nerezová mlžítka a mlžné brány pro náměstí, parky a pěší zóny.', image: 'https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/6482eed7c_generated_image.png' },
  { slug: 'garden', title: 'Zahradní kolekce', eyebrow: 'Zahrady a terasy', text: 'Čisté nerezové mlžítko pro soukromé zahrady, hotelové a restaurační terasy.', image: 'https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/3dd798c07_generated_image.png' },
  { slug: 'art', title: 'Autorská kolekce', eyebrow: 'Autorské instalace', text: 'Mlžné skulptury a řešení na míru jako součást identity konkrétního místa.', image: 'https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/de82205a7_generated_image.png' }
];
