...
const OFFERS = [
  { title: 'City Collection', eyebrow: 'Veřejný prostor', text: 'Odolné mlžné brány a architektonické prvky pro náměstí, parky a pěší zóny.', image: 'https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/17e1fc843_MlznabranaGATE70U.png' },
  { title: 'Garden Collection', eyebrow: 'Zahrady a terasy', text: 'Elegantní nerezové prvky pro soukromé venkovní zóny, hotely a gastro provozy.', image: 'https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/91ce94feb_MlzitkoAURA.JPG' },
  { title: 'Art Collection', eyebrow: 'Autorské instalace', text: 'Mlžné skulptury a řešení na míru, které se stávají součástí identity konkrétního místa.', image: 'https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/96ec1f8e9_mlnprvek-mrak-mlzidla04.png' }
];
...
export default function CollectionOffers() {
  return <section className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-24">
    ...
    <div className="grid gap-5 lg:grid-cols-3">{OFFERS.map((offer) => <a key={offer.title} href="#catalog" className="group border border-slate-200 bg-white overflow-hidden hover:border-slate-400 transition-colors">
