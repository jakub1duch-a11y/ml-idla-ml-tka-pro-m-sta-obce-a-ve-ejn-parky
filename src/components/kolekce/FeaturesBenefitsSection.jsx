        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <motion.div
            ...
            className="group p-6 rounded-2xl border border-slate-200 hover:border-slate-300 hover:shadow-md transition-all overflow-hidden bg-[hsl(var(--foreground))] text-[hsl(var(--card))]">
              ...
              className="w-11 h-11 rounded-xl border border-slate-200 flex items-center justify-center mb-4 group-hover:bg-slate-900 transition-colors text-[hsl(var(--popover))] bg-slate-100">
