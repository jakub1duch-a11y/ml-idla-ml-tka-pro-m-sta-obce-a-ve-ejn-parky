      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8 lg:mb-10">
          <div>
            ...
            <h2 className="text-3xl tracking-tight text-[hsl(var(--card-foreground))] [font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] lg:text-3xl font-light">Prohlédněte si
