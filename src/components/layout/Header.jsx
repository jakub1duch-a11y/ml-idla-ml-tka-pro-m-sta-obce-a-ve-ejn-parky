        ...
        <div className="flex items-center justify-between max-w-7xl lg:px-8 mx-auto gap-4 lg:gap-8 px-6 h-16">
          ...
          <Link to="/" className="flex items-center opacity-100 gap-2.5 shrink-2">
            <motion.div
              ...
              <span style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 300, letterSpacing: '0.06em' }} className={`no-underline not-italic [font-family:'Urbanist',_sans-serif] text-left leading-none text-2xl font-bold uppercase transition-colors duration-00 ${scrolled ? 'text-slate-900' : 'text-white'}`}>
