      ...
      scrolled ? 'border-b border-slate-200 shadow-sm' : 'border-b border-transparent'}`
        ...
        <div className="flex items-center justify-between max-w-7xl h-16 px-6 lg:px-8 mx-auto gap-4 lg:gap-8">
          ...
          <Link to="/" className="flex items-center gap-2 shrink-0 opacity-100">
            ...
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 300, letterSpacing: '-0.04em' }} className="text-slate-900 leading-none text-3xl no-underline not-italic font-light [font-family:'Urbanist',_sans-serif] text-left normal-case">
