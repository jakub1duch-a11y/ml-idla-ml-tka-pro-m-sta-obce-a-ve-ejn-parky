...
export default function HeaderNav() {
  ...
  return <nav className="hidden min-w-0 flex-1 xl:block"><ul className="my-0 flex list-none items-center gap-1 whitespace-nowrap">
    ...
    {LINKS.map(({ label, to }) => <li key={to}><Link to={to} className="inline-flex rounded-full px-3 py-2.5 text-xs font-medium transition-colors hover:bg-slate-100 hover:text-slate-950 text-slate-600">{label}</Link></li>)}
