...
export default function HeaderNav() {
  ...
  return <nav className="hidden xl:block min-w-0 flex-1"><ul className="flex list-none items-center gap-1 whitespace-nowrap my-0">
    ...
    <li><Link to="/katalog?sekce=pronajem" className="inline-flex items-center gap-1.5 rounded-lg bg-white/10 px-3 py-2.5 text-sm font-bold text-cyan transition hover:bg-white hover:text-slate-950"><CalendarDays size={15} /> Pronájem</Link></li>
