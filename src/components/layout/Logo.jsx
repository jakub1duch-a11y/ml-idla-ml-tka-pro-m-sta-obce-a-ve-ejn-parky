...
export default function Logo({ size = 'md' }) {
  ...
  return <div className="inline-flex items-center gap-2.5" aria-label="MLŽIDLA">
    ...
    <span className={`${wordSize} whitespace-nowrap font-heading font-extrabold leading-none tracking-[0.06em]`}><span className="text-accent">MLŽ</span><span className="text-white">IDLA</span></span>
  </div>;
}