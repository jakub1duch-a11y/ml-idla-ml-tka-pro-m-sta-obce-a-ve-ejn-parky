...
export default function MobileMenu({ open, onClose }) {
  return <AnimatePresence>{open && <motion.nav initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} transition={{ duration: 0.2 }} className="fixed top-[72px] left-3 right-3 z-40 max-h-[75vh] overflow-y-auto border border-white/10 bg-slate-950/95 shadow-2xl shadow-slate-950/40 backdrop-blur-xl min-[1440px]:hidden">
