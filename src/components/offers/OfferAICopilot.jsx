  ...
  return (
    <section className="mt-6 overflow-hidden rounded-2xl border border-cyan-200 bg-white">
      <div className="flex flex-col gap-3 border-b border-cyan-100 bg-[#0d2d38] px-5 py-4 text-white lg:flex-row lg:items-center lg:justify-between">
        <div><p className="flex items-center gap-2 text-xs font-semibold text-[#61d5e5]"><Bot size={15}/> AI Offer Studio</p><p className="mt-1 text-sm text-white/70">1. Podklad → 2. realistická vizualizace → 3. čisté PDF. Bez zbytečných mezikroků.</p></div>
      ...
      <div className="grid gap-0 lg:grid-cols-[1.05fr_.95fr]">
        <details className="border-b border-cyan-100 p-5 lg:border-b-0 lg:border-r">
          <summary className="cursor-pointer list-none text-xs font-semibold text-slate-700">Pokročilý AI asistent · texty a kontrola <span className="ml-1 text-slate-400">(volitelné)</span></summary>
          <div className="mt-4">
