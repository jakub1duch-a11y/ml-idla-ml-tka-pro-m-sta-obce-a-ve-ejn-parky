    ...
    <section className="py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-3xl mb-14">
          <h2 className="text-4xl lg:text-5xl text-slate-900 tracking-tight mb-5 [font-family:'Architects_Daughter',_system-ui]">Design, který ochlazuje prostor.</h2>
          <p className="text-slate-700 text-lg font-normal leading-[1.8]">
