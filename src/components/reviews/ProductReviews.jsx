    ...
    <section className="max-w-7xl mx-auto px-6 lg:px-10 py-20 border-t border-slate-200">
      <div className="flex items-end justify-between flex-wrap gap-6 mb-10">
        <div>
          ...
          <h2 style={{ fontWeight: 700, fontSize: 'clamp(2rem, 4vw, 3rem)', letterSpacing: '-0.04em' }} className="[font-family:'Inter',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] font-s">
