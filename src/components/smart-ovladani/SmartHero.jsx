  ...
  return <section className="relative overflow-hidden bg-primary pb-20 pt-32 lg:pb-28">
    ...
    <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-[1.05fr_.95fr] lg:px-10">
      <motion.div initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
        ...
        <div className="mt-8 flex flex-wrap items-center gap-4"><Link to="/kontakt?produkt=Smart%20ovl%C3%A1d%C3%A1n%C3%AD" className="btn-metallic-mist px-7 py-3.5 text-sm font-bold">Poptat chytré řešení <ArrowRight size={16} /></Link><a href="#varianty" className="inline-flex items-center gap-2 rounded-full border border-white/20 px-6 py-3.5 text-sm font-semibold text-white/80 transition hover:border-white/40 hover:text-white">Porovnat varianty</a></div>
      </motion.div>
