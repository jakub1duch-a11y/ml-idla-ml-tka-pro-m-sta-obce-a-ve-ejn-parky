...
export default function SmartHero() {
  return <section className="relative overflow-hidden bg-primary pb-20 pt-28 sm:pt-32 lg:pb-28">
    ...
    <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-[1.05fr_.95fr] lg:px-10">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white shadow-2xl"><motion.img initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.1 }} src="https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/5c4b99749_Smartmlzitka-ovladanizmobilu.jpg" alt="Ovládání mlžítka z mobilní aplikace" className="aspect-[4/3] w-full bg-white object-contain opacity-95" /><div className="relative mx-3 -mt-12 sm:mx-10 sm:-mt-20"><AutomationPreview /></div></div>
    </div>
  </section>;
}