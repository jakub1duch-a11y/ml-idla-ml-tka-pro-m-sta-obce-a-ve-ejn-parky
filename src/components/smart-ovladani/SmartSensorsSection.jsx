      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
          ...
          <div className="relative h-[430px] sm:h-[480px] lg:h-[520px]"><img src="https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/585985745_smartaplikacepromlzutka-nova.png"
            alt="Aplikace pro chytré mlžítko se senzory" className="absolute inset-0 w-full h-full object-contain bg-white" /><div className="absolute inset-0 bg-gradient-to-t from-slate-950/20 via-transparent to-transparent" /><div className="absolute inset-x-4 bottom-4 grid grid-cols-3 gap-2"><div className="rounded-xl border border-white/20 bg-slate-950/70 p-2.5 text-white backdrop-blur sm:p-3"><p className="font-mono text-[9px] tracking-widest text-white/50">TEPLOTA</p><p className="mt-1 text-xs font-semibold sm:text-sm">28,6 °C</p></div><div className="rounded-xl border border-white/20 bg-slate-950/70 p-2.5 text-white backdrop-blur sm:p-3"><p className="font-mono text-[9px] tracking-widest text-white/50">REŽIM</p><p className="mt-1 text-xs font-semibold sm:text-sm">AUTO</p></div><div className="rounded-xl border border-white/20 bg-slate-950/70 p-2.5 text-white backdrop-blur sm:p-3"><p className="font-mono text-[9px] tracking-widest text-white/50">ZÓNA</p><p className="mt-1 text-xs font-semibold sm:text-sm">AKTIVNÍ</p></div></div></div>
        </motion.div>
