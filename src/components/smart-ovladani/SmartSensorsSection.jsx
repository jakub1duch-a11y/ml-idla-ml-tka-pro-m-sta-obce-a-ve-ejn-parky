    ...
    <section className="border-y border-slate-200 bg-slate-50 py-20 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
          className="order-2 overflow-hidden rounded-3xl border border-slate-200 shadow-sm ring-1 ring-black/[.02] lg:order-1">
          <div className="relative h-[430px] sm:h-[480px] lg:h-[520px]"><img src="/media/optimized/585985745_smartaplikacepromlzutka-nova.webp"
