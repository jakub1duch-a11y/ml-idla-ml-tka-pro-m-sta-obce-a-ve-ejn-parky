    ...
    <div className="max-w-5xl mx-auto px-6 lg:px-8 py-14 border-t border-slate-100 bg-slate-50">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-10">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <h2 className="font-light text-xl text-slate-900 tracking-tight mb-2 [font-family:'DM_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif]">1. Trvalé kotvení (Profesionální)</h2>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
          <h2 className="font-light text-xl text-slate-900 tracking-tight mb-2 [font-family:'DM_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif]">2. Mobilní instalace (Zahradní)</h2>
          <ul className="text-sm text-slate-500 space-y-1.5 list-disc list-inside">
