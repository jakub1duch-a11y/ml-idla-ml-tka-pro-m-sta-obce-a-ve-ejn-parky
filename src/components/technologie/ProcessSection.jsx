  ...
  return (
    <div className="max-w-5xl mx-auto px-6 lg:px-8 py-14 border-t border-slate-100">
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
        <h2 className="font-light text-3xl lg:text-4xl text-slate-900 tracking-tight mb-2 [font-family:'DM_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif]">Zhmotňujeme vaši vizi.</h2>
