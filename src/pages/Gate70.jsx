  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-6 lg:px-10 pb-16">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }}>
            ...
            className="text-white uppercase text-3xl">GATE70</h1>
            ...
            <p className="text-white/60 text-base lg:text-lg max-w-xl mb-8 leading-relaxed font-light">
              Designová mlžná brána z nerezové oceli AISI 316L. Pět trysek vytváří jemnou mlhovou clonu, která ochladí procházejícího o až 9 °C — bez kapek na zemi, bez hluku, s plně integrovaným Wi-Fi Smart řízením.
            </p>
            ...
            <div className="flex flex-wrap gap-8 mb-10">
              ...
              map((s) =>
              <div key={s.label}>
                  <p style={{ fontWeight: 700, fontSize: '1.6rem', letterSpacing: '-0.04em', lineHeight: 1 }} className="text-white">{s.val}</p>
            ...
            <Link to="/poptavka"
            className="items-center gap-2 px-7 py-3.5 bg-white text-slate-900 text-sm font-bold rounded-full hover:bg-white/90 transition-all btn-metallic-mist">Poptat mlžnou bránu GATE70
      ...
      {/* ══════════════════════════════════════════════════════
                                                                    ...
                                                                    ══════════════════════════════════════════════════════ */}
      <section className="max-w-7xl mx-auto lg:px-10 pt-12 pr-6 pl-6 pb-10">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-14">
          ...
          style={{ fontWeight: 700, fontSize: 'clamp(2.5rem, 5vw, 4rem)', letterSpacing: '-0.04em', lineHeight: 1.0 }} className="text-slate-900">
            Vyberte svůj <span className="text-[hsl(var(--secondary))] [font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] font-light no-underline not-italic">GATE70.</span>
          </motion.h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          className="relative overflow-hidden rounded-2xl border border-slate-200 group cursor-pointer"
          onClick={() => setLightbox({ images: v.images, idx: 0 })}>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <div className="flex items-center gap-2 mb-3">
                  <span className="px-3 py-1 bg-white/90 border border-white/40 text-slate-900 text-xs font-mono tracking-widest uppercase rounded-full">{v.label}</span>
                </div>
                <p className="text-[11px] font-mono text-white/60 tracking-widest uppercase mb-2">{v.tag}</p>
                ...
                <p className="text-white/70 text-sm mt-3 leading-relaxed font-light">{v.desc}</p>
              </div>
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          onClick={() => setLightbox({ images: ALL_GALLERY, idx: 0 })}>
            ...
            <div className="relative ml-auto mr-8 lg:mr-14 w-full max-w-md p-8 lg:p-10 rounded-2xl backdrop-blur-xl border border-white/50 shadow-2xl bg-white/25" onClick={(e) => e.stopPropagation()}>
              <span className="inline-block px-4 py-1.5 rounded-full border border-slate-200 text-slate-600 text-sm mb-6 bg-[hsl(var(--background))] [font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] font-medium">Brána, která osvěžuje</span>
              <h2 style={{ lineHeight: 1.15, fontWeight: 700, fontSize: 'clamp(1.6rem, 2.6vw, 2.1rem)', letterSpacing: '-0.02em' }} className="mb-6 text-[hsl(var(--card))]">
                Minimalistická. Funkční. Krásná.
              </h2>
              <p className="text-sm leading-relaxed mb-4 text-[hsl(var(--background))] [font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] font-semibold">GATE70 je víc než mlžné zařízení — je to architektonický prvek, který definuje vstup do prostoru…

              </p>
              <p className="leading-relaxed font-light mb-6 text-[hsl(var(--card))] text-2xl">Pět až osm mlžných trysek.
              ...
              <Link to="/poptavka"
              className="items-center gap-2 px-7 py-3.5 bg-slate-900 text-white text-sm font-bold rounded-full hover:bg-slate-800 transition-all btn-metallic-mist">Nezávazná poptávka
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
            style={{ lineHeight: 1.0, fontWeight: 700, fontSize: 'clamp(2.2rem, 4vw, 3.5rem)', letterSpacing: '-0.04em' }} className="text-slate-900 mb-10">
              Preciznost<br /><span className="no-underline not-italic [font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] font-light">v každém detailu.</span>
            </motion.h2>
            <div className="rounded-2xl overflow-hidden border border-slate-200 mb-6">
              {TECH_ROWS.map((row, i) =>
              <div key={row.label} className={`flex items-center justify-between gap-4 px-6 py-4 ${i % 2 === 0 ? 'bg-white' : 'bg-slate-50'}`}>
                  <span className="text-xs font-mono text-slate-400 tracking-widest uppercase shrink-0">{row.label}</span>
                  <span className="text-sm text-slate-900 font-medium text-right">{row.value}</span>
                </div>
              )}
            </div>
            <p className="text-xs text-slate-300 font-mono leading-relaxed mb-5">* Cena v základním rozměru, bez instalace, dopravného a balného. Rozměry lze měnit dle požadavků architekta nebo zadavatele.</p>
            <a href="mailto:obchod1@holmtec.cz?subject=Technický list GATE70"
            className="inline-flex items-center gap-2 px-5 py-2.5 border border-slate-300 text-slate-900 text-xs font-mono tracking-widest uppercase rounded-full hover:bg-slate-100 transition-all">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm">
                <div className="w-11 h-11 flex items-center justify-center mb-6">
                  <f.icon size={28} className="text-slate-900" strokeWidth={1.75} />
                </div>
      ...
      {/* ══════════════════════════════════════════════════════
                                                                    ...
                                                                    ══════════════════════════════════════════════════════ */}
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-24 lg:py-24">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
          ...
          style={{ lineHeight: 1.0, fontWeight: 700, fontSize: 'clamp(2.5rem, 4.5vw, 4rem)', letterSpacing: '-0.04em' }} className="text-slate-900">
            GATE70<br /><span className="no-underline not-italic text-[hsl(var(--ring))] [font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] font-light">v detailu.</span>
          </motion.h2>
        </motion.div>
        ...
        <div className="overflow-x-auto pb-3 snap-x snap-mandatory scrollbar-thin">
          <div className="grid grid-rows-2 grid-flow-col gap-3 w-max">
            ...
            onClick={() => setLightbox({ images: ALL_GALLERY, idx: i })}>
                ...
                <div className="absolute inset-0 transition-all bg-black/55 group-hover:bg-black/00" />
              </motion.div>
            )}
          </div>
        </div>
        ...
        <div className="flex justify-center gap-1.5 mt-5">
          ...
          <span key={i} className={`h-1.5 rounded-full transition-all ${i === 0 ? 'w-6 bg-slate-700' : 'w-1.5 bg-slate-200'}`} />
          )}
        </div>
      </section>
      ...
      {/* ══════════════════════════════════════════════════════
                                                                       7. VIDEA V AKCI
                                                                    ══════════════════════════════════════════════════════ */}
      <section id="video" className="border-y border-slate-200 scroll-mt-24 py-24 bg-[hsl(var(--ring))]">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 bg-[hsl(var(--ring))]">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
            <p className="font-mono tracking-widest uppercase mb-3 text-sm text-[hsl(var(--background))] pt-16 pb-2">VIDEA</p>
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
            style={{ lineHeight: 1.0, fontWeight: 700, fontSize: 'clamp(2.5rem, 4.5vw, 4rem)', letterSpacing: '-0.04em' }} className="text-slate-900">
              GATE70<br /><span className="[font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] font-light no-underline not-italic text-[hsl(var(--background))]">v akci.</span>
            </motion.h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            className="rounded-xl overflow-hidden border border-slate-200 shadow-sm pb-1 mb-1">
                <video src={v.url} controls playsInline className="w-full bg-black" />
                <div className="px-4 py-3">
                  <p className="font-mono tracking-widest uppercase leading-snug text-sm text-[hsl(var(--popover-foreground))]">{v.caption}</p>
                </div>
              </motion.div>
            )}
          </div>
      ...
      <section className="max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
          <p className="font-mono tracking-widest uppercase text-slate-400 mb-3 text-sm hidden">REALIZACE</p>
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
          style={{ lineHeight: 1.0, fontWeight: 700, fontSize: 'clamp(2.5rem, 4.5vw, 4rem)', letterSpacing: '-0.04em' }} className="text-slate-900 hidden">
            GATE70<br /><span className="italic text-4xl">v reálném světě.</span>
          </motion.h2>
        </motion.div>
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <h2 style={{ lineHeight: 1.0, fontWeight: 700, fontSize: 'clamp(2rem, 3.5vw, 3rem)', letterSpacing: '-0.04em' }} className="text-slate-900 mb-4">
                Váš prostor si zaslouží<br /><span className="no-underline not-italic font-light [font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif]">vlastní GATE70.</span>
              </h2>
              ...
              <div className="space-y-2 mb-8">
                ...
                map((v) =>
                <div key={v.label} className="flex items-center gap-4 px-5 py-4 rounded-xl bg-white border border-slate-200">
                    <span className="px-3 py-1 bg-slate-100 border border-slate-200 text-slate-900 text-xs font-mono rounded-full">{v.label}</span>
                    <span className="text-slate-500 text-sm font-light">{v.sub}</span>
                  </div>
                )}
              </div>

              <div className="space-y-2 text-sm font-mono text-slate-500">
                <a href="tel:+420774700390" className="flex items-center gap-2 hover:text-slate-900 transition-colors">📞 +420 774 700 390</a>
                <a href="mailto:obchod1@holmtec.cz" className="flex items-center gap-2 hover:text-slate-900 transition-colors">✉ obchod1@holmtec.cz</a>
              </div>
            </motion.div>
  ...
  return (
    <form onSubmit={submit} className="space-y-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block text-xs font-mono text-slate-400 tracking-widest uppercase mb-2">Jméno *</label>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-xs font-mono text-slate-400 tracking-widest uppercase mb-2">Varianta</label>
          <select value={form.variant} onChange={(e) => setForm((f) => ({ ...f, variant: e.target.value }))}
          className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-slate-900 text-sm focus:outline-none focus:border-slate-400 transition-colors">
      ...
      <div>
        <label className="block text-xs font-mono text-slate-400 tracking-widest uppercase mb-2">Projekt / zpráva</label>
      ...
      className="w-full py-4 bg-slate-900 text-white text-sm font-bold rounded-full hover:bg-slate-800 transition-all disabled:opacity-60 flex items-center justify-center gap-2">
        {sending ? <span className="w-4 h-4 border border-white border-t-transparent rounded-full animate-spin" /> : <>Odeslat poptávku na GATE70 <ArrowRight size={16} /></>}
      </button>
    </form>);
