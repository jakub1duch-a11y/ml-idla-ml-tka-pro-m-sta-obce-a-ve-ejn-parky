  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="video" className="bg-slate-50 border-y border-slate-200 scroll-mt-24 py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
            <p className="font-mono tracking-widest uppercase mb-3 text-sm text-[hsl(var(--background))]">VIDEA</p>
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
            style={{ lineHeight: 1.0, fontWeight: 700, fontSize: 'clamp(2.5rem, 4.5vw, 4rem)', letterSpacing: '-0.04em' }} className="text-slate-900">
      ...
      <section className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 py-12 hidden">
          ...
          onClick={() => setLightbox({ images: INSTALACE.map((x) => x.img), idx: i })}>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/10 to-transparent py-4" />
              <div className="absolute bottom-0 left-0 right-0 p-5">
                ...
                <p style={{ fontWeight: 700, letterSpacing: '-0.02em', lineHeight: 1.15 }} className="text-white">{item.title}</p>
              </div>
            </motion.div>
          )}
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <h2 style={{ lineHeight: 1.0, fontWeight: 700, fontSize: 'clamp(2rem, 3.5vw, 3rem)', letterSpacing: '-0.04em' }} className="text-slate-900 mb-4">
                Váš prostor si zaslouží<br /><span className="no-underline not-italic">vlastní GATE70.</span>
              </h2>
