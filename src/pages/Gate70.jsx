...
const INSTALACE = [
{ img: 'https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/a2d77392e_Mlnbranyaportaly.jpg', title: "Testov\xE1n\xED ml\u017En\xE9 br\xE1ny GATE70", location: 'Praha — promenáda' },
{ img: 'https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/7a9bd010a_mlnbrnyaportaly-mlzidla.jpg', title: 'Veřejné prostranství', location: 'Centrum města' },
{ img: 'https://media.base44.com/images/public/6a3ee88c10959cd3588c4d68/6a116eb0b_mlnbranaGATE70U-mlzitkapromesta.png', title: "Ml\u017En\xE1 br\xE1na v rekrea\u010Dn\xEDm st", location: "Ml\u017En\xE1 br\xE1na pro Rekrea\u010Dn\xED camp" }];
      ...
      <section className="bg-surface border-y border-white/8 py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="rounded-2xl overflow-hidden mb-5 border border-white/10">
            ...
            <div className="bg-card_bg px-6 py-4">
              <p className="text-xs font-mono text-white/35 tracking-widest uppercase">{VIDEOS[0].caption}</p>
            </div>
          </div>
