    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-6 lg:px-10 pb-16">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }}>
            ...
            className="text-white uppercase text-left text-5xl">GATE70</h1>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-24 lg:py-32">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-14">
          <p className="text-xs font-mono tracking-widest uppercase text-slate-400 mb-3">Dvě tvarové varianty</p>
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          onClick={() => setLightbox({ images: ALL_GALLERY, idx: 0 })}>
            ...
            <div className="relative ml-auto mr-8 lg:mr-14 w-full max-w-md p-8 lg:p-10 rounded-2xl bg-white/95 backdrop-blur-xl border border-white/50 shadow-2xl" onClick={(e) => e.stopPropagation()}>
              <span className="inline-block px-4 py-1.5 rounded-full border border-slate-200 text-slate-600 text-sm mb-6">Brána, která osvěžuje</span>
              <h2 style={{ lineHeight: 1.15, fontWeight: 700, fontSize: 'clamp(1.6rem, 2.6vw, 2.1rem)', letterSpacing: '-0.02em' }} className="text-slate-900 mb-6">
