        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          onClick={() => setLightbox({ images: INSTALACE.map((x) => x.img), idx: i })}>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5">
                ...
                <p style={{ fontWeight: 700, letterSpacing: '-0.02em', lineHeight: 1.15 }} className="text-white text-2xl [font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] font-light">{item.title}</p>
              </div>
            </motion.div>
          )}
        </div>
