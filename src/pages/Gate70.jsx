  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-6 lg:px-10 pb-16">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }}>
            ...
            className="text-white uppercase mb-6 text-4xl">GATE70</h1>
            ...
            className="text-white/50 text-xs font-mono tracking-widest uppercase mb-4 hidden">{variant.tag}
            </motion.p>
      ...
      {/* ══════════════════════════════════════════════════════
                                ...
                                ══════════════════════════════════════════════════════ */}
      <section className="max-w-7xl mx-auto px-6 lg:px-10 lg:py-32">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-14">
          ...
          style={{ fontWeight: 700, fontSize: 'clamp(2.5rem, 5vw, 4rem)', letterSpacing: '-0.04em', lineHeight: 1.0 }} className="text-slate-900 hidden">
            Vyberte svůj <span className="italic"></span>
          </motion.h2>
        </motion.div>
