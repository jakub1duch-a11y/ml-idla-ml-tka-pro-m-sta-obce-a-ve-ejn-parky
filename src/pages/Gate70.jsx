      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-6 lg:px-10 pb-16">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }}>
            <p className="font-mono tracking-[0.3em] uppercase text-white/60 mb-3 hidden text-2xl text-left">Mlžidla.cz · Mlžné brány a portály</p>
            ...
            <motion.p key={variant.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
            className="text-xs font-mono tracking-widest uppercase mb-4 text-[hsl(var(--card))] hidden">{variant.tag}
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          onClick={() => setLightbox({ images: ALL_GALLERY, idx: 0 })}>
            ...
            <div className="relative ml-auto mr-8 lg:mr-14 w-full max-w-md p-8 lg:p-10 rounded-2xl backdrop-blur-xl border border-white/50 shadow-2xl bg-white/25" onClick={(e) => e.stopPropagation()}>
              ...
              <p className="text-sm leading-relaxed font-light mb-8 text-[hsl(var(--card))] hidden">Rozměry upravitelné dle projektové dokumentace / Kotvení skrytou patkou pod úrovní terénu / Není herní prvek — designový architektonický prvek
