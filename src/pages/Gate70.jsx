      ...
      <section className="max-w-7xl mx-auto lg:px-10 pt-12 pr-6 pl-6 pb-10">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-14">
          ...
          style={{ fontWeight: 700, fontSize: 'clamp(2.5rem, 5vw, 4rem)', letterSpacing: '-0.04em', lineHeight: 1.0 }} className="text-slate-900">
            Vyberte svůj <span className="italic text-[hsl(var(--secondary))] [font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] font-light">GATE70.</span>
          </motion.h2>
        </motion.div>
