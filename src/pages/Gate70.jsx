  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="video" className="bg-slate-50 border-y border-slate-200 scroll-mt-24 py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
            <p className="font-mono tracking-widest uppercase text-slate-400 mb-3 text-sm">VIDEA</p>
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
            style={{ lineHeight: 1.0, fontWeight: 700, fontSize: 'clamp(2.5rem, 4.5vw, 4rem)', letterSpacing: '-0.04em' }} className="text-slate-900">
              GATE70<br /><span className="[font-family:'Plus_Jakarta_Sans',_'Helvetica_Neue',_Helvetica,_Arial,_sans-serif] font-light no-underline not-italic">v akci.</span>
            </motion.h2>
          </motion.div>
