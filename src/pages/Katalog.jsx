    ...
    <div className="min-h-screen pt-24 bg-[hsl(var(--popover-foreground))]">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 pb-8">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <h1 className="content-title mb-3 text-2xl text-[hsl(var(--card))]">Mlžítka, příslušenství a Smart systém.</h1>
          <p className="content-lead max-w-2xl pb-5">Přehled řešení pro příjemnější venkovní prostor — od mlžných bran po chytré řízení.</p>
        </motion.div>

        <FeatureIconRow items={CATALOG_FEATURES} className="mb-10" />

        <nav aria-label="Kategorie katalogu" className="sticky top-16 z-20 -mx-3 overflow-x-auto border-y border-slate-200 px-3 py-3 backdrop-blur-xl bg-[hsl(var(--card-foreground))]">
