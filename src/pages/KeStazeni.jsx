...
const STATIC_DOCS = [
  ...
  { title: 'Údržba mlžících trysek — postup čištění', desc: 'Sestava trysky, postup demontáže, čištění od vodního kamene, tipy pro čištění. Doporučujeme provádět každých 6 měsíců.', category: 'Manuál', icon: Wrench, url: 'https://media.base44.com/files/public/6a3ee88c10959cd3588c4d68/96db07d39_drbatrysek.pdf' },
