      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-white/60 text-base leading-relaxed font-light mb-6">Díky našim výrobním technologiím bogatým zkušenostem a velkému množství tvářecích nástrojů dokážeme nerez tvarovat přesně podle přání zákazníků do organických i abstraktních linií — ať už jde o stylizované zvířecí motivy, stromy či mraky.
