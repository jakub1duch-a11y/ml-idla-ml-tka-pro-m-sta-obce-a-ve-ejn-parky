    ...
    <div className="min-h-screen bg-white">
      ...
      <div ref={tabsNavRef} className="sticky top-16 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 flex flex-col sm:flex-row sm:items-center">
          <div className="flex items-center gap-3 py-2.5 sm:py-4 border-b sm:border-b-0 sm:border-r border-slate-200 sm:pr-6 lg:pr-8 shrink-0 order-1">
          ...
          <div className="relative flex-1 min-w-0 order-2 sm:order-2 sm:pl-6 lg:pl-8">
            {canScrollLeft &&
