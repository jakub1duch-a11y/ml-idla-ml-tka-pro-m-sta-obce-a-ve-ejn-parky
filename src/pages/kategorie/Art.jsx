...
<section className="hero-motion-surface hero-category relative h-[80vh] min-h-[560px] w-full overflow-hidden bg-slate-900">
        <HeroAtmosphere />
        <HeroBackgroundVideo src="/media/optimized/94c2b5f74_instalace-mlzitka-mrak.webm" poster="/media/hero-posters/art.webp" className="absolute inset-0 w-full h-full object-cover" />
